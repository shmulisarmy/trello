...
return (function () {
        ...
        function issueAjaxRequest(verb, path, elt, event, etc, actual_swap) {
            console.log("issueAjaxRequest", {verb, path, elt, event, etc})
            var resolve = null;
            var reject = null;
            etc = etc != null ? etc : {};
            ...
            xhr.onload = function () {
                ...
                try {
                    ...
                    responseHandler(elt, responseInfo, actual_swap);
        ...
        function handleAjaxResponse(elt, responseInfo, actual_swap) {
            ...
            if (beforeSwapDetails.shouldSwap) {
                ...
                var doSwap = function (actual_swap) {
                    // undefined()
                    ...
                    try {
                        ...
                        selectAndSwap(actual_swap || swapSpec.swapStyle, target, elt, serverResponse, settleInfo);
                ...
                if (swapSpec.swapDelay > 0) {
                    setTimeout(() => doSwap(actual_swap), swapSpec.swapDelay)
                } else {
                    doSwap(actual_swap);
                }
            }
        ...
        window.issueAjaxRequest = issueAjaxRequest
        return htmx;
    }
)()
}));